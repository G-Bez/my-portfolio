...
-   **Vector data**: represent spatial features with points, lines, polygons and other discrete geometries.
-   **Raster data**: represent spatial features with continuous grids of pixels.

For all intents and purposes, R can be used as a GIS. Following I provide some examples on how to deal with vector data in R. See [GIS with R - Raster data](https://g-bez.github.io/my-portfolio/posts/gis_raster/) for examples about raster data.
